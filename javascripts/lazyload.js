...
function init(location){
   ...
   if(location === "Jita"){
      ...
      station_sell3 = RENS;
      station_sell4 = HEK;
      $('#dataTable').append("<tr><td>Item</td><td>Buy at Jita</td><td>Sell at Amarr</td><td>Sell at Dodixie</td><td>Sell at Rens</td><td>Sell at Hek</td></tr>")
      ...
      station_sell3 = RENS;
      station_sell4 = HEK;
      $('#dataTable').append("<tr><td>Item</td><td>Buy at Amarr</td><td>Sell at Jita</td><td>Sell at Dodixie</td><td>Sell at Rens</td><td>Sell at Hek</td></tr>")
      ...
      station_sell3 = RENS;
      station_sell4 = HEK;
      $('#dataTable').append("<tr><td>Item</td><td>Buy at Dodoxie</td><td>Sell at Amarr</td><td>Sell at Jita</td><td>Sell at Rens</td><td>Sell at Hek</td></tr>")
      ...
      station_sell3 = JITA;
      station_sell4 = HEK;
      $('#dataTable').append("<tr><td>Item</td><td>Buy at Rens</td><td>Sell at Amarr</td><td>Sell at Dodixie</td><td>Sell at Jita</td><td>Sell at Hek</td></tr>")
   }else {
      station_buy = HEK;
      station_sell1 = AMARR;
      station_sell2 = DODIXIE;
      station_sell3 = RENS;
      station_sell4 = JITA;
      $('#dataTable').append("<tr><td>Item</td><td>Buy at Hekk</td><td>Sell at Amarr</td><td>Sell at Dodixie</td><td>Sell at Rens</td><td>Sell at Jita</td></tr>")
   }
